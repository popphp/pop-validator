...
class Ipv4 extends AbstractValidator
{
    ...
    public function evaluate(mixed $input = null): bool
    {
        ...
        return (bool)(preg_match('/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/', (string)$inputValue));
    }
